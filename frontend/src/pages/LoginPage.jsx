  ...
  return (
    <div className="auth-page">
      <div className="auth-card fade-in">
        ...
        <h1 style={{ fontSize: 26, fontWeight: 800, color: 'var(--zen-dark)', marginBottom: 6, letterSpacing: '-0.02em' }}>Welcome back</h1>
        <p style={{ color: 'var(--zen-gray-500)', fontSize: 14, marginBottom: 28 }}>Log in to your financial sanctuary</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            <div className="flex justify-between items-center mb-2">
              ...
              <a href="#" style={{ fontSize: 12, color: 'var(--zen-green)', fontWeight: 500 }}>Forgot password?</a>
            </div>
          ...
          >
            {loading
              ? <><div style={{ width: 16, height: 16, border: '2px solid rgba(255,255,255,.4)', borderTop: '2px solid white', borderRadius: '50%', animation: 'spin 1s linear infinite' }} /> Signing in…</>
              : 'Log In'
            }
          </button>
        </form>
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: 'var(--zen-gray-500)', marginTop: 24 }}>
          ...
          <Link to="/signup" style={{ color: 'var(--zen-green)', fontWeight: 600 }}>Sign up for free</Link>
        </p>
      </div>
    </div>
  );
